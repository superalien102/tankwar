...
export default function Credits({isOpen, onClose}: {isOpen: boolean; onClose: () => void}) {
	const credits = useRef([
		{name: 'Webstie', linkedin: 'https://www.linkedin.com/in/nicolas-crausaz-861876104/', github: 'https://github.com/nicrausaz'},
		...
		>
			...
			<div className='w-full space-y-4 p-4'>
				<div className=' flex flex-col items-center space-y-2'>
					<h2 className='text-xl font-bold text-gray-800 dark:text-gray-200'>Socials Network</h2>
				...
				<div className='space-y-2 text-gray-600 dark:text-gray-300'>
					...
					<ul className='grid list-inside grid-cols-3 gap-2'>
						<li>1. Launch Game V1</li>
						<li>2. Launch Token</li>
						<li>3. Launch Community</li>
						<li>4. P2E Integration</li>
						<li>5. Partnerships</li>
						<li>6. List CMC & CGC</li>
						<li>7. KOL & Influencer</li>
						<li>8. AI Integration</li>
						<li>9. TBD</li>
					</ul>
				</div>
